...
const ApprovedReviewsCard = () => {
    // Obtener el estado de Redux
    const allReviews = useSelector((state) => state.allReviews);

    // Contar el número total de reseñas aprobadas
    const totalApprovedReviews = allReviews.filter(review => review.status === 'approved').length;
    ...
    return (
        <Card className="mx-auto max-w-xs flex flex-col items-center justify-center text-center h-48" decoration="top" fill="#8884d8">
            ...
            <p className="text-sm text-tremor-content dark:text-dark-tremor-content">Total de Reseñas Aprobadas:</p>
...
export default ApprovedReviewsCard;
